...
class TensorParallel:
    def __init__(self, model, devices):
        ...
        for i, block in enumerate(model.transformer_blocks):
            ...
            modules = {'q': block.attn.to_q, 'k': block.attn.to_k, 'v': block.attn.to_v,
                       'o': block.attn.to_out[0], 'gu': block.img_mlp.gate_up, 'down': block.img_mlp.out}
